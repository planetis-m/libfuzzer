...
proc customMutator(data: openarray[byte], maxLen: int, seed: int64): cint {.
...
proc customCrossOver(data1: openarray[byte], data2: openarray[byte],
    res: openarray[byte], maxOutLen: int, seed: int64): int {.
...
proc mutate(data: openarray[byte], maxLen: int, seed: int64): int {.
